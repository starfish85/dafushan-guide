...
const raw = [
  ...
  spot('cuijing', '翠景湖', 'attraction', 0.4849, 0.0739),
  spot('yunxiu', '云岫湖', 'attraction', 0.5099, 0.0864),
  spot('danche', '单车驿站', 'attraction', 0.4982, 0.0931, {
    intro: `单车驿站，童趣园在旁边。${MAP_NOTE}`,
  }),
  spot('youtian-north', '游艇码头', 'attraction', 0.4386, 0.1039),
  spot('yayunlin', '亚运林', 'attraction', 0.5065, 0.1316),
  spot('qiandao', '千岛湖', 'attraction', 0.5481, 0.1341),
  spot('shuishang', '水上乐园', 'attraction', 0.4656, 0.1442),
  spot('qingyun', '晴云湖', 'attraction', 0.4313, 0.1597),
  spot('xuanlan', '绚烂杉塘', 'attraction', 0.454, 0.1697),
  ...
  spot('junziyuan', '君子苑', 'attraction', 0.4302, 0.3247, { recommendMin: 15 }),
  spot('yueduba', '悦读吧', 'attraction', 0.4401, 0.323, { recommendMin: 10 }),
  ...
  spot('guanli', '公园管理处', 'attraction', 0.6692, 0.843),
  spot('yingbin', '迎宾园', 'attraction', 0.6625, 0.8852),
  spot('nanmen-guangchang', '南门入口广场', 'attraction', 0.6768, 0.9292),
